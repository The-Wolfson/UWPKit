...
/// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.devices.enumeration.panel)
public typealias Panel = __x_ABI_CWindows_CDevices_CEnumeration_CPanel
...
public final class EnclosureLocation : WinRTClass {
    ...
    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.devices.enumeration.enclosurelocation.panel)
...
extension UWP.Panel {
    public static var unknown : UWP.Panel {
        __x_ABI_CWindows_CDevices_CEnumeration_CPanel_Unknown
    }
    public static var front : UWP.Panel {
        __x_ABI_CWindows_CDevices_CEnumeration_CPanel_Front
    }
    public static var back : UWP.Panel {
        __x_ABI_CWindows_CDevices_CEnumeration_CPanel_Back
    }
    public static var top : UWP.Panel {
        __x_ABI_CWindows_CDevices_CEnumeration_CPanel_Top
    }
    public static var bottom : UWP.Panel {
        __x_ABI_CWindows_CDevices_CEnumeration_CPanel_Bottom
    }
    public static var left : UWP.Panel {
        __x_ABI_CWindows_CDevices_CEnumeration_CPanel_Left
    }
    public static var right : UWP.Panel {
        __x_ABI_CWindows_CDevices_CEnumeration_CPanel_Right
    }
}
extension UWP.Panel: @retroactive Hashable, @retroactive Codable, @retroactive @unchecked Sendable {}
