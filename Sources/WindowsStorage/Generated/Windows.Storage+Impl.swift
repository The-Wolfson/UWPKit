...
public enum __IMPL_Windows_Storage {
    ...
    public enum AppDataPathsBridge: AbiBridge {
        public typealias SwiftProjection = AppDataPaths
        public typealias CABI = __x_ABI_CWindows_CStorage_CIAppDataPaths
        public static func from(abi: ComPtr<__x_ABI_CWindows_CStorage_CIAppDataPaths>?) -> AppDataPaths? {
            guard let abi = abi else { return nil }
    ...
    public enum ApplicationDataCompositeValueBridge: AbiBridge {
        public typealias SwiftProjection = ApplicationDataCompositeValue
        public typealias CABI = __x_ABI_CWindows_CFoundation_CCollections_CIPropertySet
        public static func from(abi: ComPtr<__x_ABI_CWindows_CFoundation_CCollections_CIPropertySet>?) -> ApplicationDataCompositeValue? {
            guard let abi = abi else { return nil }
            return .init(fromAbi: WindowsFoundation.IInspectable(abi))
        }
    }
    ...
    public enum ApplicationDataContainerSettingsBridge: AbiBridge {
        public typealias SwiftProjection = ApplicationDataContainerSettings
        public typealias CABI = __x_ABI_CWindows_CFoundation_CCollections_CIPropertySet
        public static func from(abi: ComPtr<__x_ABI_CWindows_CFoundation_CCollections_CIPropertySet>?) -> ApplicationDataContainerSettings? {
            guard let abi = abi else { return nil }
            return .init(fromAbi: WindowsFoundation.IInspectable(abi))
        }
    }
    ...
    public enum StorageLibraryBridge: AbiBridge {
        public typealias SwiftProjection = StorageLibrary
        public typealias CABI = __x_ABI_CWindows_CStorage_CIStorageLibrary
        public static func from(abi: ComPtr<__x_ABI_CWindows_CStorage_CIStorageLibrary>?) -> StorageLibrary? {
            guard let abi = abi else { return nil }
            return .init(fromAbi: WindowsFoundation.IInspectable(abi))
        }
    }
    ...
    public enum SystemAudioPropertiesBridge: AbiBridge {
        public typealias SwiftProjection = SystemAudioProperties
        public typealias CABI = __x_ABI_CWindows_CStorage_CISystemAudioProperties
        public static func from(abi: ComPtr<__x_ABI_CWindows_CStorage_CISystemAudioProperties>?) -> SystemAudioProperties? {
            guard let abi = abi else { return nil }
            return .init(fromAbi: WindowsFoundation.IInspectable(abi))
        }
    }

    public enum SystemDataPathsBridge: AbiBridge {
        public typealias SwiftProjection = SystemDataPaths
        public typealias CABI = __x_ABI_CWindows_CStorage_CISystemDataPaths
        public static func from(abi: ComPtr<__x_ABI_CWindows_CStorage_CISystemDataPaths>?) -> SystemDataPaths? {
            guard let abi = abi else { return nil }
            return .init(fromAbi: WindowsFoundation.IInspectable(abi))
        }
    }

    public enum SystemGPSPropertiesBridge: AbiBridge {
        public typealias SwiftProjection = SystemGPSProperties
        public typealias CABI = __x_ABI_CWindows_CStorage_CISystemGPSProperties
        public static func from(abi: ComPtr<__x_ABI_CWindows_CStorage_CISystemGPSProperties>?) -> SystemGPSProperties? {
            guard let abi = abi else { return nil }
            return .init(fromAbi: WindowsFoundation.IInspectable(abi))
        }
    }

    public enum SystemImagePropertiesBridge: AbiBridge {
        public typealias SwiftProjection = SystemImageProperties
        public typealias CABI = __x_ABI_CWindows_CStorage_CISystemImageProperties
        public static func from(abi: ComPtr<__x_ABI_CWindows_CStorage_CISystemImageProperties>?) -> SystemImageProperties? {
            guard let abi = abi else { return nil }
            return .init(fromAbi: WindowsFoundation.IInspectable(abi))
        }
    }

    public enum SystemMediaPropertiesBridge: AbiBridge {
        public typealias SwiftProjection = SystemMediaProperties
        public typealias CABI = __x_ABI_CWindows_CStorage_CISystemMediaProperties
        public static func from(abi: ComPtr<__x_ABI_CWindows_CStorage_CISystemMediaProperties>?) -> SystemMediaProperties? {
            guard let abi = abi else { return nil }
            return .init(fromAbi: WindowsFoundation.IInspectable(abi))
        }
    }

    public enum SystemMusicPropertiesBridge: AbiBridge {
        public typealias SwiftProjection = SystemMusicProperties
        public typealias CABI = __x_ABI_CWindows_CStorage_CISystemMusicProperties
        public static func from(abi: ComPtr<__x_ABI_CWindows_CStorage_CISystemMusicProperties>?) -> SystemMusicProperties? {
            guard let abi = abi else { return nil }
            return .init(fromAbi: WindowsFoundation.IInspectable(abi))
        }
    }

    public enum SystemPhotoPropertiesBridge: AbiBridge {
        public typealias SwiftProjection = SystemPhotoProperties
        public typealias CABI = __x_ABI_CWindows_CStorage_CISystemPhotoProperties
        public static func from(abi: ComPtr<__x_ABI_CWindows_CStorage_CISystemPhotoProperties>?) -> SystemPhotoProperties? {
            guard let abi = abi else { return nil }
            return .init(fromAbi: WindowsFoundation.IInspectable(abi))
        }
    }

    public enum SystemVideoPropertiesBridge: AbiBridge {
        public typealias SwiftProjection = SystemVideoProperties
        public typealias CABI = __x_ABI_CWindows_CStorage_CISystemVideoProperties
        public static func from(abi: ComPtr<__x_ABI_CWindows_CStorage_CISystemVideoProperties>?) -> SystemVideoProperties? {
            guard let abi = abi else { return nil }
            return .init(fromAbi: WindowsFoundation.IInspectable(abi))
        }
    }

    public enum UserDataPathsBridge: AbiBridge {
        public typealias SwiftProjection = UserDataPaths
        public typealias CABI = __x_ABI_CWindows_CStorage_CIUserDataPaths
        public static func from(abi: ComPtr<__x_ABI_CWindows_CStorage_CIUserDataPaths>?) -> UserDataPaths? {
            guard let abi = abi else { return nil }
            return .init(fromAbi: WindowsFoundation.IInspectable(abi))
        }
    }
...
@_spi(WinRTInternal)
public class AppDataPathsMaker: MakeFromAbi {
    public typealias SwiftType = AppDataPaths
    public static func from(abi: WindowsFoundation.IInspectable) -> SwiftType {
        return AppDataPaths(fromAbi: abi)
    }
}
@_spi(WinRTInternal)
...
@_spi(WinRTInternal)
public class ApplicationDataCompositeValueMaker: MakeFromAbi {
    public typealias SwiftType = ApplicationDataCompositeValue
    public static func from(abi: WindowsFoundation.IInspectable) -> SwiftType {
        return ApplicationDataCompositeValue(fromAbi: abi)
    }
}
@_spi(WinRTInternal)
...
@_spi(WinRTInternal)
public class ApplicationDataContainerSettingsMaker: MakeFromAbi {
    public typealias SwiftType = ApplicationDataContainerSettings
    public static func from(abi: WindowsFoundation.IInspectable) -> SwiftType {
        return ApplicationDataContainerSettings(fromAbi: abi)
    }
}
@_spi(WinRTInternal)
...
@_spi(WinRTInternal)
public class StorageLibraryMaker: MakeFromAbi {
    public typealias SwiftType = StorageLibrary
    public static func from(abi: WindowsFoundation.IInspectable) -> SwiftType {
        return StorageLibrary(fromAbi: abi)
    }
}
@_spi(WinRTInternal)
...
@_spi(WinRTInternal)
public class SystemAudioPropertiesMaker: MakeFromAbi {
    public typealias SwiftType = SystemAudioProperties
    public static func from(abi: WindowsFoundation.IInspectable) -> SwiftType {
        return SystemAudioProperties(fromAbi: abi)
    }
}
@_spi(WinRTInternal)
public class SystemDataPathsMaker: MakeFromAbi {
    public typealias SwiftType = SystemDataPaths
    public static func from(abi: WindowsFoundation.IInspectable) -> SwiftType {
        return SystemDataPaths(fromAbi: abi)
    }
}
@_spi(WinRTInternal)
public class SystemGPSPropertiesMaker: MakeFromAbi {
    public typealias SwiftType = SystemGPSProperties
    public static func from(abi: WindowsFoundation.IInspectable) -> SwiftType {
        return SystemGPSProperties(fromAbi: abi)
    }
}
@_spi(WinRTInternal)
public class SystemImagePropertiesMaker: MakeFromAbi {
    public typealias SwiftType = SystemImageProperties
    public static func from(abi: WindowsFoundation.IInspectable) -> SwiftType {
        return SystemImageProperties(fromAbi: abi)
    }
}
@_spi(WinRTInternal)
public class SystemMediaPropertiesMaker: MakeFromAbi {
    public typealias SwiftType = SystemMediaProperties
    public static func from(abi: WindowsFoundation.IInspectable) -> SwiftType {
        return SystemMediaProperties(fromAbi: abi)
    }
}
@_spi(WinRTInternal)
public class SystemMusicPropertiesMaker: MakeFromAbi {
    public typealias SwiftType = SystemMusicProperties
    public static func from(abi: WindowsFoundation.IInspectable) -> SwiftType {
        return SystemMusicProperties(fromAbi: abi)
    }
}
@_spi(WinRTInternal)
public class SystemPhotoPropertiesMaker: MakeFromAbi {
    public typealias SwiftType = SystemPhotoProperties
    public static func from(abi: WindowsFoundation.IInspectable) -> SwiftType {
        return SystemPhotoProperties(fromAbi: abi)
    }
}
@_spi(WinRTInternal)
public class SystemVideoPropertiesMaker: MakeFromAbi {
    public typealias SwiftType = SystemVideoProperties
    public static func from(abi: WindowsFoundation.IInspectable) -> SwiftType {
        return SystemVideoProperties(fromAbi: abi)
    }
}
@_spi(WinRTInternal)
public class UserDataPathsMaker: MakeFromAbi {
    public typealias SwiftType = UserDataPaths
    public static func from(abi: WindowsFoundation.IInspectable) -> SwiftType {
        return UserDataPaths(fromAbi: abi)
    }
}
