...
private var IID___x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatus: WindowsFoundation.IID {
    .init(Data1: 0xbb185a07, Data2: 0x0285, Data3: 0x5f37, Data4: ( 0x9c,0x7d,0x2f,0xc6,0xa3,0xe0,0xe6,0xe5 ))// bb185a07-0285-5f37-9c7d-2fc6a3e0e6e5
}

internal extension WinRTDelegateBridge where CABI == __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatus {
    static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &UWP.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusVTable) { $0 }
        return .init(lpVtbl:vtblPtr)
    }
}

internal var __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusVTable: __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusVtbl = .init(
    QueryInterface: { __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper.addRef($0) },
    Release: { __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper.release($0) },
    Invoke: {
        do {
            guard let __unwrapped__instance = __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
            let asyncInfo: WindowsFoundation.AnyIAsyncOperation<UWP.FileUpdateStatus>? = UWP.__x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper.unwrapFrom(abi: ComPtr($1))
            let asyncStatus: WindowsFoundation.AsyncStatus = $2
            try __unwrapped__instance(asyncInfo, asyncStatus)
            return S_OK
        } catch { return failWith(error: error) }
...
typealias __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper = InterfaceWrapperBase<UWP.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusBridge>
public class AsyncOperationCompletedHandlerFileUpdateStatus: WindowsFoundation.IUnknown {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatus }

    open func Invoke(_ asyncInfo: WindowsFoundation.AnyIAsyncOperation<UWP.FileUpdateStatus>?, _ asyncStatus: WindowsFoundation.AsyncStatus) throws {
        let asyncInfoWrapper = UWP.__x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper(asyncInfo)
        let _asyncInfo = try! asyncInfoWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatus.self) { pThis in
            try CHECKED(pThis.pointee.lpVtbl.pointee.Invoke(pThis, _asyncInfo, asyncStatus))
        }
    }
...
internal class __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusBridge : WinRTDelegateBridge {
    internal typealias Handler = WindowsFoundation.AsyncOperationCompletedHandler<UWP.FileUpdateStatus>
    internal typealias CABI = __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatus
    internal typealias SwiftABI = UWP.AsyncOperationCompletedHandlerFileUpdateStatus
...
private var IID___x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibrary: WindowsFoundation.IID {
    .init(Data1: 0x36d560c3, Data2: 0x731f, Data3: 0x5c70, Data4: ( 0xb9,0x07,0x30,0xbc,0x99,0xbc,0x30,0x0f ))// 36d560c3-731f-5c70-b907-30bc99bc300f
}

internal extension WinRTDelegateBridge where CABI == __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibrary {
    static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &UWP.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryVTable) { $0 }
        return .init(lpVtbl:vtblPtr)
    }
}

internal var __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryVTable: __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryVtbl = .init(
    QueryInterface: { __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper.addRef($0) },
    Release: { __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper.release($0) },
    Invoke: {
        do {
            guard let __unwrapped__instance = __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
            let asyncInfo: WindowsFoundation.AnyIAsyncOperation<UWP.StorageLibrary?>? = UWP.__x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper.unwrapFrom(abi: ComPtr($1))
            let asyncStatus: WindowsFoundation.AsyncStatus = $2
            try __unwrapped__instance(asyncInfo, asyncStatus)
            return S_OK
        } catch { return failWith(error: error) }
...
typealias __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper = InterfaceWrapperBase<UWP.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryBridge>
public class AsyncOperationCompletedHandlerStorageLibrary: WindowsFoundation.IUnknown {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibrary }

    open func Invoke(_ asyncInfo: WindowsFoundation.AnyIAsyncOperation<UWP.StorageLibrary?>?, _ asyncStatus: WindowsFoundation.AsyncStatus) throws {
        let asyncInfoWrapper = UWP.__x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper(asyncInfo)
        let _asyncInfo = try! asyncInfoWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibrary.self) { pThis in
            try CHECKED(pThis.pointee.lpVtbl.pointee.Invoke(pThis, _asyncInfo, asyncStatus))
        }
    }
...
internal class __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryBridge : WinRTDelegateBridge {
    internal typealias Handler = WindowsFoundation.AsyncOperationCompletedHandler<UWP.StorageLibrary?>
    internal typealias CABI = __x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibrary
    internal typealias SwiftABI = UWP.AsyncOperationCompletedHandlerStorageLibrary
...
private var IID___x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolder: WindowsFoundation.IID {
    .init(Data1: 0x358f44df, Data2: 0x2a45, Data3: 0x5cb8, Data4: ( 0x93,0x85,0x1f,0xf6,0x68,0x08,0xcd,0xe0 ))// 358f44df-2a45-5cb8-9385-1ff66808cde0
}

internal var __x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderVTable: __x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderVtbl = .init(
    QueryInterface: { __x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.addRef($0) },
    Release: { __x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.release($0) },
    GetIids: {
        let size = MemoryLayout<WindowsFoundation.IID>.size
        let iids = CoTaskMemAlloc(UInt64(size) * 5).assumingMemoryBound(to: WindowsFoundation.IID.self)
        iids[0] = IUnknown.IID
        iids[1] = IInspectable.IID
        iids[2] = UWP.__x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.IID
        iids[3] = UWP.__x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.IID
        iids[4] = UWP.__x_ABI_C__FIIterable_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.IID
        $1!.pointee = 5
        $2!.pointee = iids
        return S_OK
    },
    ...
    GetRuntimeClassName: {
        _ = $0
        let hstring = try! HString("Windows.Foundation.Collections.IObservableVector`1<Windows.Storage.StorageFolder>").detach()
        $1!.pointee = hstring
        return S_OK
    },
    ...
    add_VectorChanged: {
        guard let __unwrapped__instance = __x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        guard let vhnd = UWP.__x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.unwrapFrom(abi: ComPtr($1)) else { return E_INVALIDARG }
...
typealias __x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper = InterfaceWrapperBase<UWP.__x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderBridge>
public class IObservableVectorStorageFolder: WindowsFoundation.IInspectable {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolder }

    open func add_VectorChanged(_ vhnd: VectorChangedEventHandler<UWP.StorageFolder?>?) throws -> EventRegistrationToken {
        var result: EventRegistrationToken = .init()
        let vhndWrapper = UWP.__x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper(vhnd)
        let _vhnd = try! vhndWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolder.self) { pThis in
...
internal enum __x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderBridge : AbiInterfaceBridge {
    internal typealias CABI = __x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolder
    internal typealias SwiftABI = IObservableVectorStorageFolder
    internal typealias SwiftProjection = WindowsFoundation.AnyIObservableVector<UWP.StorageFolder?>
    internal static func from(abi: ComPtr<CABI>?) -> SwiftProjection? {
        guard let abi = abi else { return nil }
        return __x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderImpl(abi)
    }

    internal static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &__x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderVTable) { $0 }
        return .init(lpVtbl: vtblPtr)
    }
}

fileprivate class __x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderImpl : IObservableVector, AbiInterfaceImpl {
    typealias T = UWP.StorageFolder?
    typealias Bridge = __x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderBridge
    let _default: Bridge.SwiftABI
    init(_ fromAbi: ComPtr<Bridge.CABI>) {
        _default = Bridge.SwiftABI(fromAbi)
    }
    ...
    fileprivate lazy var vectorChanged : Event<VectorChangedEventHandler<StorageFolder?>> = {
      .init(
        add: { [weak self] in
          guard let this = self?._default else { return .init() }
    ...
    private lazy var _IVector: IVectorStorageFolder! = getInterfaceForCaching()
    ...
    fileprivate func getView() -> WindowsFoundation.AnyIVectorView<UWP.StorageFolder?>? {
    ...
    fileprivate func setAt(_ index: UInt32, _ value: UWP.StorageFolder?) {
    ...
    fileprivate func insertAt(_ index: UInt32, _ value: UWP.StorageFolder?) {
    ...
    fileprivate func append(_ value: UWP.StorageFolder?) {
    ...
    fileprivate func replaceAll(_ items: [UWP.StorageFolder?]) {
...
private var IID___x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolder: WindowsFoundation.IID {
    .init(Data1: 0x6c26b7be, Data2: 0x5f01, Data3: 0x5a60, Data4: ( 0x9d,0xd7,0xfd,0x17,0xbe,0x3a,0x9d,0xd6 ))// 6c26b7be-5f01-5a60-9dd7-fd17be3a9dd6
}

internal var __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderVTable: __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderVtbl = .init(
    QueryInterface: { __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.addRef($0) },
    Release: { __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.release($0) },
    GetIids: {
        let size = MemoryLayout<WindowsFoundation.IID>.size
        let iids = CoTaskMemAlloc(UInt64(size) * 4).assumingMemoryBound(to: WindowsFoundation.IID.self)
        iids[0] = IUnknown.IID
        iids[1] = IInspectable.IID
        iids[2] = UWP.__x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.IID
        iids[3] = UWP.__x_ABI_C__FIIterable_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.IID
        $1!.pointee = 4
        $2!.pointee = iids
        return S_OK
    ...
    GetRuntimeClassName: {
        _ = $0
        let hstring = try! HString("Windows.Foundation.Collections.IVector`1<Windows.Storage.StorageFolder>").detach()
        $1!.pointee = hstring
        return S_OK
    },
    ...
    GetAt: {
        guard let __unwrapped__instance = __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        let index: UInt32 = $1
        let result = __unwrapped__instance.getAt(index)
        result?.copyTo($2)
        return S_OK
    ...
    SetAt: {
        guard let __unwrapped__instance = __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        let index: UInt32 = $1
        let value: UWP.StorageFolder? = __IMPL_Windows_Storage.StorageFolderBridge.from(abi: ComPtr($2))
        __unwrapped__instance.setAt(index, value)
        return S_OK
    },
    ...
    ReplaceAll: {
        guard let __unwrapped__instance = __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        let items: [UWP.StorageFolder?] = .from(abiBridge: __IMPL_Windows_Storage.StorageFolderBridge.self, abi: (count: $1, start: $2))
        __unwrapped__instance.replaceAll(items)
        return S_OK
    }
)
typealias __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper = InterfaceWrapperBase<UWP.__x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderBridge>
public class IVectorStorageFolder: WindowsFoundation.IInspectable {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolder }

    open func GetAt(_ index: UInt32) throws -> UWP.StorageFolder? {
        let (result) = try ComPtrs.initialize { resultAbi in
            _ = try perform(as: __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolder.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.GetAt(pThis, index, &resultAbi))
            }
        }
        return __IMPL_Windows_Storage.StorageFolderBridge.from(abi: result)
    ...
    open func GetView() throws -> WindowsFoundation.AnyIVectorView<UWP.StorageFolder?>? {
        let (result) = try ComPtrs.initialize { resultAbi in
            _ = try perform(as: __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolder.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.GetView(pThis, &resultAbi))
            }
    ...
    open func SetAt(_ index: UInt32, _ value: UWP.StorageFolder?) throws {
        _ = try perform(as: __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolder.self) { pThis in
            try CHECKED(pThis.pointee.lpVtbl.pointee.SetAt(pThis, index, RawPointer(value)))
        }
    }

    open func InsertAt(_ index: UInt32, _ value: UWP.StorageFolder?) throws {
        _ = try perform(as: __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolder.self) { pThis in
    ...
    open func Append(_ value: UWP.StorageFolder?) throws {
        _ = try perform(as: __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolder.self) { pThis in
    ...
    open func ReplaceAll(_ items: [UWP.StorageFolder?]) throws {
        try items.toABI(abiBridge: __IMPL_Windows_Storage.StorageFolderBridge.self) { _items in
            _ = try perform(as: __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolder.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.ReplaceAll(pThis, _items.count, _items.start))
            }
...
internal enum __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderBridge : AbiInterfaceBridge {
    internal typealias CABI = __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolder
    internal typealias SwiftABI = IVectorStorageFolder
    internal typealias SwiftProjection = WindowsFoundation.AnyIVector<UWP.StorageFolder?>
    internal static func from(abi: ComPtr<CABI>?) -> SwiftProjection? {
        guard let abi = abi else { return nil }
        return __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderImpl(abi)
    }

    internal static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &__x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderVTable) { $0 }
        return .init(lpVtbl: vtblPtr)
    }
}

fileprivate class __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderImpl : IVector, AbiInterfaceImpl {
    typealias T = UWP.StorageFolder?
    typealias Bridge = __x_ABI_C__FIVector_1___x_ABI_CWindows__CStorage__CStorageFolderBridge
    let _default: Bridge.SwiftABI
    init(_ fromAbi: ComPtr<Bridge.CABI>) {
        _default = Bridge.SwiftABI(fromAbi)
    }
...
private var IID___x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolder: WindowsFoundation.IID {
    .init(Data1: 0x2057b641, Data2: 0x4b9b, Data3: 0x5338, Data4: ( 0xa1,0x9a,0xe9,0xa9,0x51,0x91,0x67,0x75 ))// 2057b641-4b9b-5338-a19a-e9a951916775
}

internal extension WinRTDelegateBridge where CABI == __x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolder {
    static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &UWP.__x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolderVTable) { $0 }
        return .init(lpVtbl:vtblPtr)
    }
}

internal var __x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolderVTable: __x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolderVtbl = .init(
    QueryInterface: { __x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.addRef($0) },
    Release: { __x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.release($0) },
    Invoke: {
        do {
            guard let __unwrapped__instance = __x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
            let sender: WindowsFoundation.AnyIObservableVector<UWP.StorageFolder?>? = UWP.__x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper.unwrapFrom(abi: ComPtr($1))
...
typealias __x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper = InterfaceWrapperBase<UWP.__x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolderBridge>
public class VectorChangedEventHandlerStorageFolder: WindowsFoundation.IUnknown {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolder }

    open func Invoke(_ sender: WindowsFoundation.AnyIObservableVector<UWP.StorageFolder?>?, _ event: WindowsFoundation.AnyIVectorChangedEventArgs?) throws {
        let senderWrapper = UWP.__x_ABI_C__FIObservableVector_1___x_ABI_CWindows__CStorage__CStorageFolderWrapper(sender)
        let _sender = try! senderWrapper?.toABI { $0 }
        let eventWrapper = __ABI_Windows_Foundation_Collections.IVectorChangedEventArgsWrapper(event)
        let _event = try! eventWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolder.self) { pThis in
            try CHECKED(pThis.pointee.lpVtbl.pointee.Invoke(pThis, _sender, _event))
        }
    }
...
internal class __x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolderBridge : WinRTDelegateBridge {
    internal typealias Handler = WindowsFoundation.VectorChangedEventHandler<UWP.StorageFolder?>
    internal typealias CABI = __x_ABI_C__FVectorChangedEventHandler_1___x_ABI_CWindows__CStorage__CStorageFolder
    internal typealias SwiftABI = UWP.VectorChangedEventHandlerStorageFolder
...
private var IID___x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatus: WindowsFoundation.IID {
    .init(Data1: 0x8f0f439e, Data2: 0x87d0, Data3: 0x531f, Data4: ( 0x85,0xb1,0x54,0xf4,0x52,0x8f,0x29,0xc3 ))// 8f0f439e-87d0-531f-85b1-54f4528f29c3
}

internal var __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusVTable: __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusVtbl = .init(
    QueryInterface: { __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper.addRef($0) },
    Release: { __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper.release($0) },
    GetIids: {
        let size = MemoryLayout<WindowsFoundation.IID>.size
        let iids = CoTaskMemAlloc(UInt64(size) * 4).assumingMemoryBound(to: WindowsFoundation.IID.self)
        iids[0] = IUnknown.IID
        iids[1] = IInspectable.IID
        iids[2] = UWP.__x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper.IID
        iids[3] = __ABI_Windows_Foundation.IAsyncInfoWrapper.IID
        $1!.pointee = 4
        $2!.pointee = iids
        return S_OK
    ...
    GetRuntimeClassName: {
        _ = $0
        let hstring = try! HString("Windows.Foundation.IAsyncOperation`1<Windows.Storage.Provider.FileUpdateStatus>").detach()
        $1!.pointee = hstring
        return S_OK
    },
    ...
    put_Completed: {
        guard let __unwrapped__instance = __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        guard let handler = UWP.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper.unwrapFrom(abi: ComPtr($1)) else { return E_INVALIDARG }
        __unwrapped__instance.completed = handler
        return S_OK
    },
    ...
    get_Completed: {
        guard let __unwrapped__instance = __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        let result = __unwrapped__instance.completed
        let resultWrapper = UWP.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper(result)
        resultWrapper?.copyTo($1)
        return S_OK
    },
...
typealias __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper = InterfaceWrapperBase<UWP.__x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusBridge>
public class IAsyncOperationFileUpdateStatus: WindowsFoundation.IInspectable {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatus }

    open func put_Completed(_ handler: AsyncOperationCompletedHandler<UWP.FileUpdateStatus>?) throws {
        let handlerWrapper = UWP.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper(handler)
        let _handler = try! handlerWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatus.self) { pThis in
            try CHECKED(pThis.pointee.lpVtbl.pointee.put_Completed(pThis, _handler))
        }
    }

    open func get_Completed() throws -> AsyncOperationCompletedHandler<UWP.FileUpdateStatus>? {
        let (result) = try ComPtrs.initialize { resultAbi in
            _ = try perform(as: __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatus.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.get_Completed(pThis, &resultAbi))
            }
        }
        return UWP.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusWrapper.unwrapFrom(abi: result)
    }

    open func GetResults() throws -> UWP.FileUpdateStatus {
        var result: __x_ABI_CWindows_CStorage_CProvider_CFileUpdateStatus = .init(0)
        _ = try perform(as: __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatus.self) { pThis in
            try CHECKED(pThis.pointee.lpVtbl.pointee.GetResults(pThis, &result))
        }
        return result
...
internal enum __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusBridge : AbiInterfaceBridge {
    internal typealias CABI = __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatus
    internal typealias SwiftABI = IAsyncOperationFileUpdateStatus
    internal typealias SwiftProjection = WindowsFoundation.AnyIAsyncOperation<UWP.FileUpdateStatus>
    internal static func from(abi: ComPtr<CABI>?) -> SwiftProjection? {
        guard let abi = abi else { return nil }
        return __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusImpl(abi)
    }

    internal static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &__x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusVTable) { $0 }
        return .init(lpVtbl: vtblPtr)
    }
}

fileprivate class __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusImpl : IAsyncOperation, AbiInterfaceImpl {
    typealias TResult = UWP.FileUpdateStatus
    typealias Bridge = __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CProvider__CFileUpdateStatusBridge
    let _default: Bridge.SwiftABI
    init(_ fromAbi: ComPtr<Bridge.CABI>) {
        _default = Bridge.SwiftABI(fromAbi)
    }
    ...
    // MARK: WinRT
    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.iasyncoperation-1.getresults)
    fileprivate func getResults() throws -> UWP.FileUpdateStatus {
        try _default.GetResults()
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.iasyncoperation-1.completed)
    fileprivate var completed : AsyncOperationCompletedHandler<UWP.FileUpdateStatus>? {
        get { try! _default.get_Completed() }
        set { try! _default.put_Completed(newValue) }
    }
...
private var IID___x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibrary: WindowsFoundation.IID {
    .init(Data1: 0x2f160a19, Data2: 0x99c1, Data3: 0x52b9, Data4: ( 0x8d,0xca,0x14,0xe4,0xab,0x79,0xf2,0x87 ))// 2f160a19-99c1-52b9-8dca-14e4ab79f287
}

internal var __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryVTable: __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryVtbl = .init(
    QueryInterface: { __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper.addRef($0) },
    Release: { __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper.release($0) },
    GetIids: {
        let size = MemoryLayout<WindowsFoundation.IID>.size
        let iids = CoTaskMemAlloc(UInt64(size) * 4).assumingMemoryBound(to: WindowsFoundation.IID.self)
        iids[0] = IUnknown.IID
        iids[1] = IInspectable.IID
        iids[2] = UWP.__x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper.IID
        iids[3] = __ABI_Windows_Foundation.IAsyncInfoWrapper.IID
        $1!.pointee = 4
        $2!.pointee = iids
        return S_OK
    ...
    GetRuntimeClassName: {
        _ = $0
        let hstring = try! HString("Windows.Foundation.IAsyncOperation`1<Windows.Storage.StorageLibrary>").detach()
        $1!.pointee = hstring
        return S_OK
    },
    ...
    put_Completed: {
        guard let __unwrapped__instance = __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        guard let handler = UWP.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper.unwrapFrom(abi: ComPtr($1)) else { return E_INVALIDARG }
        __unwrapped__instance.completed = handler
        return S_OK
    },
    ...
    get_Completed: {
        guard let __unwrapped__instance = __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
        let result = __unwrapped__instance.completed
        let resultWrapper = UWP.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper(result)
        resultWrapper?.copyTo($1)
        return S_OK
    },
...
typealias __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper = InterfaceWrapperBase<UWP.__x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryBridge>
public class IAsyncOperationStorageLibrary: WindowsFoundation.IInspectable {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibrary }

    open func put_Completed(_ handler: AsyncOperationCompletedHandler<UWP.StorageLibrary?>?) throws {
        let handlerWrapper = UWP.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper(handler)
        let _handler = try! handlerWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibrary.self) { pThis in
            try CHECKED(pThis.pointee.lpVtbl.pointee.put_Completed(pThis, _handler))
        }
    }

    open func get_Completed() throws -> AsyncOperationCompletedHandler<UWP.StorageLibrary?>? {
        let (result) = try ComPtrs.initialize { resultAbi in
            _ = try perform(as: __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibrary.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.get_Completed(pThis, &resultAbi))
            }
        }
        return UWP.__x_ABI_C__FIAsyncOperationCompletedHandler_1___x_ABI_CWindows__CStorage__CStorageLibraryWrapper.unwrapFrom(abi: result)
    }

    open func GetResults() throws -> UWP.StorageLibrary? {
        let (result) = try ComPtrs.initialize { resultAbi in
            _ = try perform(as: __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibrary.self) { pThis in
                try CHECKED(pThis.pointee.lpVtbl.pointee.GetResults(pThis, &resultAbi))
            }
        }
        return __IMPL_Windows_Storage.StorageLibraryBridge.from(abi: result)
    }

}

internal enum __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryBridge : AbiInterfaceBridge {
    internal typealias CABI = __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibrary
    internal typealias SwiftABI = IAsyncOperationStorageLibrary
    internal typealias SwiftProjection = WindowsFoundation.AnyIAsyncOperation<UWP.StorageLibrary?>
    internal static func from(abi: ComPtr<CABI>?) -> SwiftProjection? {
        guard let abi = abi else { return nil }
        return __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryImpl(abi)
    }

    internal static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &__x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryVTable) { $0 }
        return .init(lpVtbl: vtblPtr)
    }
}

fileprivate class __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryImpl : IAsyncOperation, AbiInterfaceImpl {
    typealias TResult = UWP.StorageLibrary?
    typealias Bridge = __x_ABI_C__FIAsyncOperation_1___x_ABI_CWindows__CStorage__CStorageLibraryBridge
    let _default: Bridge.SwiftABI
    init(_ fromAbi: ComPtr<Bridge.CABI>) {
        _default = Bridge.SwiftABI(fromAbi)
    }
    ...
    // MARK: WinRT
    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.iasyncoperation-1.getresults)
    fileprivate func getResults() throws -> UWP.StorageLibrary? {
        try _default.GetResults()
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.iasyncoperation-1.completed)
    fileprivate var completed : AsyncOperationCompletedHandler<UWP.StorageLibrary?>? {
        get { try! _default.get_Completed() }
        set { try! _default.put_Completed(newValue) }
    }
...
private var IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectable: WindowsFoundation.IID {
    .init(Data1: 0xedc09538, Data2: 0xbbae, Data3: 0x5b2b, Data4: ( 0x9e,0x81,0xb4,0x49,0xea,0x7e,0x48,0xfe ))// edc09538-bbae-5b2b-9e81-b449ea7e48fe
}

internal extension WinRTDelegateBridge where CABI == __x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectable {
    static func makeAbi() -> CABI {
        let vtblPtr = withUnsafeMutablePointer(to: &UWP.__x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectableVTable) { $0 }
        return .init(lpVtbl:vtblPtr)
    }
}

internal var __x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectableVTable: __x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectableVtbl = .init(
    QueryInterface: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectableWrapper.queryInterface($0, $1, $2) },
    AddRef: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectableWrapper.addRef($0) },
    Release: { __x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectableWrapper.release($0) },
    Invoke: {
        do {
            guard let __unwrapped__instance = __x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectableWrapper.tryUnwrapFrom(raw: $0) else { return E_INVALIDARG }
            let sender: UWP.StorageLibrary? = __IMPL_Windows_Storage.StorageLibraryBridge.from(abi: ComPtr($1))
            let args: Any? = __ABI_.AnyWrapper.unwrapFrom(abi: ComPtr($2))
            try __unwrapped__instance(sender, args)
            return S_OK
        } catch { return failWith(error: error) }
...
typealias __x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectableWrapper = InterfaceWrapperBase<UWP.__x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectableBridge>
public class TypedEventHandlerStorageLibrary_Any: WindowsFoundation.IUnknown {
    override public class var IID: WindowsFoundation.IID { IID___x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectable }

    open func Invoke(_ sender: UWP.StorageLibrary?, _ args: Any?) throws {
        let argsWrapper = __ABI_.AnyWrapper(args)
        let _args = try! argsWrapper?.toABI { $0 }
        _ = try perform(as: __x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectable.self) { pThis in
            try CHECKED(pThis.pointee.lpVtbl.pointee.Invoke(pThis, RawPointer(sender), _args))
        }
    }
...
internal class __x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectableBridge : WinRTDelegateBridge {
    internal typealias Handler = WindowsFoundation.TypedEventHandler<UWP.StorageLibrary?, Any?>
    internal typealias CABI = __x_ABI_C__FITypedEventHandler_2___x_ABI_CWindows__CStorage__CStorageLibrary_IInspectable
    internal typealias SwiftABI = UWP.TypedEventHandlerStorageLibrary_Any
