...
public final class PropertyValue {
    private static let _IPropertyValueStatics: __ABI_Windows_Foundation.IPropertyValueStatics = try! RoGetActivationFactory("Windows.Foundation.PropertyValue")
    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createempty)
    public static func createEmpty() throws -> Any! {
        return try _IPropertyValueStatics.CreateEmpty()
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createuint8)
    public static func createUInt8(_ value: UInt8) throws -> Any! {
        return try _IPropertyValueStatics.CreateUInt8(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createint16)
    public static func createInt16(_ value: Int16) throws -> Any! {
        return try _IPropertyValueStatics.CreateInt16(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createuint16)
    public static func createUInt16(_ value: UInt16) throws -> Any! {
        return try _IPropertyValueStatics.CreateUInt16(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createint32)
    public static func createInt32(_ value: Int32) throws -> Any! {
        return try _IPropertyValueStatics.CreateInt32(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createuint32)
    public static func createUInt32(_ value: UInt32) throws -> Any! {
        return try _IPropertyValueStatics.CreateUInt32(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createint64)
    public static func createInt64(_ value: Int64) throws -> Any! {
        return try _IPropertyValueStatics.CreateInt64(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createuint64)
    public static func createUInt64(_ value: UInt64) throws -> Any! {
        return try _IPropertyValueStatics.CreateUInt64(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createsingle)
    public static func createSingle(_ value: Float) throws -> Any! {
        return try _IPropertyValueStatics.CreateSingle(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createdouble)
    public static func createDouble(_ value: Double) throws -> Any! {
        return try _IPropertyValueStatics.CreateDouble(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createchar16)
    public static func createChar16(_ value: Character) throws -> Any! {
        return try _IPropertyValueStatics.CreateChar16(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createboolean)
    public static func createBoolean(_ value: Bool) throws -> Any! {
        return try _IPropertyValueStatics.CreateBoolean(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createstring)
    public static func createString(_ value: String) throws -> Any! {
        return try _IPropertyValueStatics.CreateString(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createinspectable)
    public static func createInspectable(_ value: Any!) throws -> Any! {
        return try _IPropertyValueStatics.CreateInspectable(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createguid)
    public static func createGuid(_ value: Foundation.UUID) throws -> Any! {
        return try _IPropertyValueStatics.CreateGuid(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createdatetime)
    public static func createDateTime(_ value: DateTime) throws -> Any! {
        return try _IPropertyValueStatics.CreateDateTime(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createtimespan)
    public static func createTimeSpan(_ value: TimeSpan) throws -> Any! {
        return try _IPropertyValueStatics.CreateTimeSpan(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createpoint)
    public static func createPoint(_ value: Point) throws -> Any! {
        return try _IPropertyValueStatics.CreatePoint(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createsize)
    public static func createSize(_ value: Size) throws -> Any! {
        return try _IPropertyValueStatics.CreateSize(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createrect)
    public static func createRect(_ value: Rect) throws -> Any! {
        return try _IPropertyValueStatics.CreateRect(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createuint8array)
    public static func createUInt8Array(_ value: [UInt8]) throws -> Any! {
        return try _IPropertyValueStatics.CreateUInt8Array(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createint16array)
    public static func createInt16Array(_ value: [Int16]) throws -> Any! {
        return try _IPropertyValueStatics.CreateInt16Array(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createuint16array)
    public static func createUInt16Array(_ value: [UInt16]) throws -> Any! {
        return try _IPropertyValueStatics.CreateUInt16Array(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createint32array)
    public static func createInt32Array(_ value: [Int32]) throws -> Any! {
        return try _IPropertyValueStatics.CreateInt32Array(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createuint32array)
    public static func createUInt32Array(_ value: [UInt32]) throws -> Any! {
        return try _IPropertyValueStatics.CreateUInt32Array(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createint64array)
    public static func createInt64Array(_ value: [Int64]) throws -> Any! {
        return try _IPropertyValueStatics.CreateInt64Array(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createuint64array)
    public static func createUInt64Array(_ value: [UInt64]) throws -> Any! {
        return try _IPropertyValueStatics.CreateUInt64Array(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createsinglearray)
    public static func createSingleArray(_ value: [Float]) throws -> Any! {
        return try _IPropertyValueStatics.CreateSingleArray(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createdoublearray)
    public static func createDoubleArray(_ value: [Double]) throws -> Any! {
        return try _IPropertyValueStatics.CreateDoubleArray(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createchar16array)
    public static func createChar16Array(_ value: [Character]) throws -> Any! {
        return try _IPropertyValueStatics.CreateChar16Array(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createbooleanarray)
    public static func createBooleanArray(_ value: [Bool]) throws -> Any! {
        return try _IPropertyValueStatics.CreateBooleanArray(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createstringarray)
    public static func createStringArray(_ value: [String]) throws -> Any! {
        return try _IPropertyValueStatics.CreateStringArray(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createinspectablearray)
    public static func createInspectableArray(_ value: [Any?]) throws -> Any! {
        return try _IPropertyValueStatics.CreateInspectableArray(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createguidarray)
    public static func createGuidArray(_ value: [Foundation.UUID]) throws -> Any! {
        return try _IPropertyValueStatics.CreateGuidArray(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createdatetimearray)
    public static func createDateTimeArray(_ value: [DateTime]) throws -> Any! {
        return try _IPropertyValueStatics.CreateDateTimeArray(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createtimespanarray)
    public static func createTimeSpanArray(_ value: [TimeSpan]) throws -> Any! {
        return try _IPropertyValueStatics.CreateTimeSpanArray(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createpointarray)
    public static func createPointArray(_ value: [Point]) throws -> Any! {
        return try _IPropertyValueStatics.CreatePointArray(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createsizearray)
    public static func createSizeArray(_ value: [Size]) throws -> Any! {
        return try _IPropertyValueStatics.CreateSizeArray(value)
    }

    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.propertyvalue.createrectarray)
    public static func createRectArray(_ value: [Rect]) throws -> Any! {
        return try _IPropertyValueStatics.CreateRectArray(value)
    }
...
public typealias AsyncActionProgressHandler<TProgress> = (AnyIAsyncActionWithProgress<TProgress>?, TProgress) throws -> ()
public typealias AsyncActionWithProgressCompletedHandler<TProgress> = (AnyIAsyncActionWithProgress<TProgress>?, AsyncStatus) throws -> ()
...
public protocol IReferenceArray<T> : IPropertyValue {
    associatedtype T
    /// [Open Microsoft documentation](https://learn.microsoft.com/uwp/api/windows.foundation.ireferencearray-1.value)
    var value: [T] { get }
}
